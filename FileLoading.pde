...
//================================================================
String getUserSelectedImageFilename () {
  ...
  println("Please select a shoe tracing image."); 
  shoeImageFilename = shoeDefaultImageFilename;
  ...
  try
  {
    ...
    chooser.setDialogTitle("Please select a shoe tracing image.");
    chooser.setApproveButtonText("Load shoe tracing image"); 
    chooser.setApproveButtonToolTipText ("Load the selected shoe tracing image. This should be a png, jpg, gif or tif."); 
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      ...
      if (ext.equals("jpg") || ext.equals("jpeg") || ext.equals("gif") || ext.equals("png")) {
        shoeImageFilename = chooser.getSelectedFile().getPath();
  ...
  if (bFailed) {
    println("Loading default shoe image: " + shoeImageFilename);
  }
  
  return shoeImageFilename;
}
